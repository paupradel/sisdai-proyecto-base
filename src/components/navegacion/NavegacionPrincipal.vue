    ...
    <div class="nav-contenedor-identidad">
      ...
      >
        <img
          ...
          width="130"
          height="38"
          src="@/assets/img/conacyt-azul.svg"
          alt="Conacyt."
        />
      </a>
      <button
        ...
        :class="{ abierto: estaNavegacionPrincipalAbierta }"
      >
      ...
      <div class="nav-menu-principal">
        <ul class="nav-menu">
          ...
          <li class="nav-contenedor-submenu">
            ...
            <ul
              class="nav-submenu"
              :class="{ abierto: estaNavegacionSubmenu1Abierta }"
            >
              <li>
                <button
